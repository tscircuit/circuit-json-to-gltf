...
test("repro3: CAD components fail to align with their PCB panel's footprints", async () => {
  const esp32BoardPath = path.join(__dirname, "../fixtures/pcb_panel.json")
  ...
  ).toMatchPngSnapshot(import.meta.path, "repro3")
})
